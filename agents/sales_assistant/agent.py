...
MAX_TOOL_ROUNDS = 8  # describe + query + possible follow-up = at least 2 rounds minimum
...
async def chat(message: str, history: list[dict]) -> str:
    ...
    Args:
        ...
        history: Prior conversation as list of {"role": ..., "content": ...} dicts.
    ...
    for round_num in range(MAX_TOOL_ROUNDS):
        try:
            ...
            if not used_fallback_prompt and _is_tool_validation_error(e):
                logger.warning("Retrying Groq call with fallback prompt after tool validation failure")
