  ...
  return (
    <div className="px-6 pb-6 pt-3 flex-shrink-0" style={{ background: 'linear-gradient(to top, #0F172A 70%, transparent)' }}>
      <div className="max-w-[800px] mx-auto">
        {/* Outer wrapper — animated border glow when focused */}
        <div className="relative">
          <AnimatePresence>
            {focused && (
              <motion.div
                className="absolute inset-[-1px] rounded-2xl pointer-events-none overflow-hidden z-0"
          ...
          <div className={`relative z-10 flex items-end gap-3 px-4 py-3.5 rounded-2xl border transition-all duration-200 ${
            focused
              ? 'bg-slate-800/90 border-transparent'
